        ...
        <div className="grid gap-8 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="mt-4 text-base text-slate-400">
              Your comprehensive guide to technology terminology. Learn, explore, and stay updated
              with the latest tech definitions.
            </p>
          </div>
          ...
          <div>
            ...
            <address className="mt-4 not-italic text-base text-slate-400">
              ...
              <p className="mt-4">
                <a href="mailto:contact@techterms.com" className="transition hover:text-indigo-400">
